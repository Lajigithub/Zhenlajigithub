...
def receivecash():
  ...
  try:
    global result
    url = 'https://fbp.api.autohome.com.cn/oil/receivecash'
    Carheader['Origin']='https://business.m.autohome.com.cn'
    body={}
    resp = requests.post(url=url,headers=Carheader,data=body,timeout=60).json()
    #print(resp)
  except Exception as e:
      msg=str(e)
      print(msg)
